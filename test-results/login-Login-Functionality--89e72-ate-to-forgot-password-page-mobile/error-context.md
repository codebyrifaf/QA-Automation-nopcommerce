...
- main:
  ...
  - heading "Electronics" [level=2]:
    - link "Electronics":
      - /url: /electronics
  - link "Show products in category Electronics":
    - /url: /electronics
  - heading "Apparel" [level=2]:
    - link "Apparel":
      - /url: /apparel
  - link "Show products in category Apparel":
    - /url: /apparel
  - heading "Digital downloads" [level=2]:
    - link "Digital downloads":
      - /url: /digital-downloads
  - link "Show products in category Digital downloads":
    - /url: /digital-downloads
  - strong: Featured products
  - link "Show details for Build your own computer":
  ...
  - link "Show details for Apple MacBook Pro":
  ...
  - button "Add to compare list"
  - button "Add to wishlist"
  - link "Show details for HTC smartphone":
    - /url: /htc-smartphone
  ...
  - button "Add to compare list"
  - button "Add to wishlist"
  - link "Show details for $25 Virtual Gift Card":
