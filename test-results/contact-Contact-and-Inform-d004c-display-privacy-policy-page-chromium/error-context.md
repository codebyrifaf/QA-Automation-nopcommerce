...
- list:
  - listitem:
    - link "Register":
      - /url: /register?returnUrl=%2Fprivacy-notice
  - listitem:
    - link "Log in":
      - /url: /login?returnUrl=%2Fprivacy-notice
  - listitem:
    - link "Wishlist (0)":
      - /url: /wishlist
  - listitem:
...
- main:
  ...
  - paragraph: Put your privacy policy information here. You can edit this in the admin site.
- strong: Information
- list:
  - listitem:
    - link "Sitemap":
